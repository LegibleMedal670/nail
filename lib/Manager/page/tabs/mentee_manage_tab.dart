...
import 'package:nail/Manager/page/MenteeDetailPage.dart';
import 'package:nail/Manager/page/mentee_edit_page.dart';
import 'package:nail/Manager/widgets/MetricCard.dart';
import 'package:nail/Manager/widgets/MenteeSummaryTile.dart';
  ...
  Future<void> _showSortSheet() async {
    final result = await showModalBottomSheet<MenteeSort>(
      ...
      builder: (_) => SortBottomSheet<MenteeSort>(
        title: '정렬 선택',
        current: _sort, // dummy, 아래 onChanged로 덮어씀
        options: [
            ...
            ListView.separated(
              ...
              itemBuilder: (context, i) {
                ...
                return MenteeSummaryTile(
                  mentee: m,
                  curriculum: [],           // 서버 전 데모
                  watchRatio: const {'w01':1.0, 'w02':0.6},
                  examMap: const {
...
//                     Navigator.of(context).push(
//                       MaterialPageRoute(
//                         builder: (_) => MenteeDetailPage.demoFromEntry(mentee),
//                       ),
//                     );
//                   },
//                 ),
