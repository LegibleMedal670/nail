...
class MentorTodoGroupsView extends StatefulWidget {
  ...
  @override
  State<MentorTodoGroupsView> createState() => MentorTodoGroupsViewState();
}
...
class MentorTodoGroupsViewState extends State<MentorTodoGroupsView> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_loading && _rowsAll.isEmpty) {
      return const Center(child: CircularProgressIndicator());
    }
    if (_error != null && _rowsAll.isEmpty) {
